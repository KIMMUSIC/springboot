...
import static com.example.springboot.exception.ErrorCode.USER_NOT_FOUND;
...
public class UserController {
    ...
    public ResponseEntity<LoginResponseDto> login(HttpServletResponse response, @RequestBody Map<String, String> user) {
